...
<pop:block region="main">
  ...
  <style type="text/css">
  .bmform_outer310362 { width:auto; }

  .bmform_inner310362{border:1px solid #dadada;}

  .bmform_head310362{background-image:url(http://www.benchmarkemail.com/images/listbuilder/th4/sk4/images/header.gif);  background-color:#215997; background-repeat:no-repeat; padding:12px 8px 12px 50px;}

  .bm_headetext310362{color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:bold;}

  .bmform_body310362{color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:14px; padding:12px; background-color:#0B3B83;}

  .bmform_introtxt310362 {
  ...
  .bmform_frmtext310362{padding: 5px 0px 3px 0px; display:block; float:none; text-align: left; text-decoration: none; width: auto; font-weight:bold;}

  .bmform_frm310362{color:#000000; display:block; float:none; font-family:Verdana,sans-serif; font-size:12px; font-style:normal; font-weight:normal; text-align:left; padding:3px; width:185px;}

  .bmform_button310362{text-align:right; padding-top:15px;}

  .bmform_submit310362{background-color: #0057AC; background-image:url(http://www.benchmarkemail.com/images/listbuilder/th4/sk4/images/button.jpg); background-position: left top; background-repeat: repeat-x; border: 1px solid #757575; color: #FFFFFF; font-family: Verdana,sans-serif; font-size: 14px; font-style:normal; font-weight:bold; padding:2px 15px 2px 15px; }

  .bmform_footer310362{}.footer_bdy310362{}.footer_txt310362{}#tdLogo310336 img310362{margin-bottom:10px; max-width:230px;}#tdLogo310362 img{margin-bottom:10px; max-width:230px;}</style>
  ...
  <div class="bmform_outer310362" id="signup-form">
