  ...
  <div id="top-bar" class="clearfix">
    ...
    <div class="top-inner">
      ...
      <ul class="social-icons fl">
        <li><a href="https://twitter.com/soupmobile" target="_blank"><span id="twitter_icon"></span></a></li>
        <li><a href="https://www.facebook.com/SoupMobile" target="_blank"><span id="facebook_icon"></span></a></li>
